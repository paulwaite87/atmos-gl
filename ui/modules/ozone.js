/**
 * Ozone Module - Ozone concentration map with automatic background updates
 */
export function loadLayer(map, config) {
    ...
    if (legendStack) {
        ...
        const existingSlot = document.getElementById('ozone-legend-slot');
        if (existingSlot) existingSlot.remove();

        const slot = document.createElement('div');
        slot.id = 'ozone-legend-slot';
