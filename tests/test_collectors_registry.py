...
resolve_embeddable now live once in atmos_gl.collectors, and atmos_gl.collectors.service
and atmos_gl.routes.status both import the same objects -- these tests guard against the
two re-diverging into hand-copied lists.
"""
import atmos_gl.collectors as collectors
import atmos_gl.collectors.service as service
import atmos_gl.routes.status as status
